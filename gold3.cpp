...
// enter Charisma and DC rand function here then apply to gold var in the future.
...
// We will use the '++' modifier before the 'gold' var to increment it by 1.
} else {
  std::cout << "Merchant: You don't have enough gold; The item is (system call): " << ++gold << ".\n";
